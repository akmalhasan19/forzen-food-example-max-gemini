  ...
  if (items.length === 0) {
    return (
      <main className="mx-auto max-w-7xl px-4 py-16 md:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-2xl font-bold text-slate-900 mb-2">Keranjang Anda kosong</h1>
        <p className="text-slate-500 mb-6">Tambahkan makanan beku favorit untuk memulai!</p>
    ...
    <main className="mx-auto max-w-7xl px-4 py-6 md:px-6 lg:px-8">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-slate-500">({totalItems()} barang)</span>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-xl border p-6 h-fit space-y-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <h3 className="text-sm font-medium text-slate-700">Opsi Pengiriman</h3>
