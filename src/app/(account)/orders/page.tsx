...
> = {
  ...
  paid: { label: "Paid", variant: "bg-blue-100 text-blue-800", Icon: Package },
  packed: { label: "Packed", variant: "bg-indigo-100 text-indigo-800", Icon: Package },
  shipped: { label: "Shipped", variant: "bg-teal-100 text-teal-800", Icon: Truck },
  delivered: { label: "Delivered", variant: "bg-green-100 text-green-800", Icon: CheckCircle2 },
      ...
      <CardContent className="space-y-3">
        ...
        >
          {expanded ? (
            ...
            <>
              View {order.items.length} Items <ChevronDown className="h-4 w-4 ml-1" />
            </>
          )}
        </Button>
