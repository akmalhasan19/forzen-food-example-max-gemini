            ...
            >
                ...
                <div className="p-8">
                    <div className="text-center mb-8 mt-2">
                        <h2 id="modal-title" className="text-2xl font-bold text-gray-900 mb-2">Welcome Back</h2>
                        <p className="text-sm text-gray-500">Enter your details to access your fresh finds.</p>
                    </div>
                    ...
                    <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="flex justify-end pt-1">
                            <button type="button" className="text-sm text-gray-500 hover:text-gray-900 transition-colors cursor-pointer">
                                Forgot Password?
                            </button>
                        </div>
                        ...
                        <button
                            type="submit"
                            className="w-full bg-[#93C572] hover:bg-[#82AA65] text-white font-semibold py-3.5 rounded-lg transition-colors mt-2 cursor-pointer"
                        >
                            Log In
                        </button>
                    </form>
